...
const ALL_NEW_ANNIV = [...NEW_ANNIV_CARDS, ...NEW_ANNIV_CARDS_B, ...NEW_ANNIV_CARDS_C, ...NEW_ANNIV_CARDS_D, ...NEW_ANNIV_CARDS_E, ...NEW_ANNIV_CARDS_F];
    ...
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
          ...
          <p className="mt-4 font-display text-2xl text-gold">Starting from ₹1499— Transportation&nbsp;</p>
