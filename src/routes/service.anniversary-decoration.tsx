...
const NEW_ANNIV_CARDS_B = [
  ...
  { id: "anniversary-b7-purple-ring-floral", img: annivB7.url, name: "Purple Floral Ring Anniversary Arch", desc: "Stunning gold ring arch covered in fresh purple, pink & white florals with a flowing purple satin drape, neon 'Happy Anniversary' sign and twin gold pedestal floral stands — recreated like the picture.", mrp: 11999, sp: 8499, off: 29, inc: ["Gold ring with fresh florals","Purple satin drape + neon sign","Twin gold floral pedestal stands"], rt: 4.9, rv: 541, best: true },
