...
const NEW_ANNIV_CARDS_C = [
  ...
  { id: "anniversary-c4-25-silver-white-ring", img: annivC4.url, name: "25th Silver & White Ring Arch", desc: "Elegant white & chrome silver ring balloon arch with a silver 'Happy Anniversary' cut-out, silver flower clusters and giant silver '25' foil numbers — recreated like the reference photo.", mrp: 4999, sp: 3499, off: 30, inc: ["✓\nWhite & chrome silver ring arch", "✓\nSilver 'Happy Anniversary' cut-out", "✓\nGiant silver '25' foil numbers"], rt: 4.8, rv: 312 },
