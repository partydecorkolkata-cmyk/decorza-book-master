...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Decorza Events | Crafting Memorable Celebrations" },
      { property: "og:description", content: "Premium event decoration & celebration planning across India. Book on WhatsApp +91 86378 70742." },
